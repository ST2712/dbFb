...
public class MostrarMunicipio {
    ...
    public MostrarMunicipio(IngresoBD base) {
    ...
    public void CreaColumnas() {
        ...
        titColumna[0] = " CODIGO ";
        titColumna[1] = " MUNICIPIO ";


    }

    public void CargaDatos() {
        datoColumna = new String[100][2];
        int i = 0;
        System.out.println(veh.size() + "" + veh.get(1));
        int d = veh.size();
        d = d / 2;
        while (i < d) {
            datoColumna[i][0] = (String) veh.get((i * 2) + 0);
            datoColumna[i][1] = (String) veh.get((i * 2) + 1);
