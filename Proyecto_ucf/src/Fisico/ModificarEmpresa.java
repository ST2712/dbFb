...
public class ModificarEmpresa {
    ...
    private JTextField codiusuat,  nombusuat,  direusuat,  teleusuat,  nudousuat,  codiespot;
    private JComboBox tipdousua;
    private IngresoBD conectar;
    JFrame usua = new JFrame("   EMPRESA   ");

    public ModificarEmpresa(IngresoBD base) {
    ...
    private class ManejadorBoton implements ActionListener {
        ...
        public void actionPerformed(ActionEvent evento) {
            ...
            if (cual.equals("INGRESAR")) {
                String sql;
                sql = "UPDATE EMPRESA  SET NOMEMP ='" + nombusuat.getText() + "',DIREMP='" + direusuat.getText() + "',TELEMP = '" + teleusuat.getText() +
                        "'where NITEMP ='" + codiespot.getText() + "'";
